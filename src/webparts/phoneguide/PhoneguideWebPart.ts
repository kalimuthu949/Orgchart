...
import * as strings from 'PhoneguideWebPartStrings';
import Phoneguide from './components/Phoneguide';
import { IPhoneguideProps } from './components/IPhoneguideProps';
...
export default class PhoneguideWebPart extends BaseClientSideWebPart<IPhoneguideWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IPhoneguideProps> = React.createElement(
      Phoneguide,
      {
